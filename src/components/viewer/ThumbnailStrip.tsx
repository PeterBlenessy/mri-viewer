    ...
    return (
      ...
      >
        ...
        <button
          ...
          className="absolute top-1 right-1 p-0.5 rounded bg-black/40 hover:bg-black/70 transition-colors"
        ...
        >
          <svg
            ...
            className={`w-4 h-4 drop-shadow-[0_0_3px_rgba(0,0,0,0.8)] ${isFavorite ? 'text-yellow-500' : 'text-gray-300'}`}
          >
        ...
        {hasAnalysis && (
          ...
          >
            <svg
              ...
              viewBox="0 0 20 20"
              fill="currentColor"
              className="w-3.5 h-3.5 text-gray-300 group-hover:text-blue-400 drop-shadow-[0_0_3px_rgba(0,0,0,0.8)] transition-colors"
            >
        ...
        {hasAnnotations && (
          <button
            ...
            className="absolute bottom-1 left-1 p-0.5 rounded bg-black/60 hover:bg-black/80 transition-colors"
          ...
          >
            <svg
              ...
              viewBox="0 0 20 20"
              fill="currentColor"
              className={`w-3.5 h-3.5 drop-shadow-[0_0_3px_rgba(0,0,0,0.8)] ${areMarkersVisible ? 'text-green-400' : 'text-gray-400'}`}
            >
